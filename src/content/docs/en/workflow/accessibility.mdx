...
- Removing the focus outline with `outline: none` for looks, without providing another focus style — making the page unusable by keyboard
- Forgetting alt text for meaningful images
- Using colors that don't meet WCAG contrast requirements

## The developer's perspective

### 👨‍💻 What developers actually see

Designers see "a page that looks nice and the contrast seems fine," but developers have to check the actual contrast ratio against WCAG, write alt text that's actually meaningful, and test with a real keyboard and screen reader.

> 💡 Real-world example
>
> UK public-sector websites are legally required to meet WCAG 2.2 AA under the Public Sector Bodies Accessibility Regulations 2018 — which is exactly why government design systems like GOV.UK's tend to be strong accessibility references. ([GOV.UK Service Manual: Accessibility](https://www.gov.uk/service-manual/helping-people-to-use-your-service/making-your-service-accessible-an-introduction))
