...
เมื่อคุณมองดูหน้าเว็บแล้วถามว่า "อันนั้นมาจากไหน?" — ถ้าเป็น content (คำ, รูปภาพ, label ปุ่ม) มาจาก HTML ถ้าเป็น visual property (สี, ขนาด, spacing) มาจาก CSS ถ้าตอบสนองต่อการคลิกหรือเปลี่ยนแปลงโดยไม่ต้อง reload หน้า นั่นคือ JavaScript
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> การแยก content (HTML) ออกจาก theme (CSS) อย่างชัดเจน คือสิ่งที่ทำให้ฟีเจอร์อย่าง dark mode toggle ทำงานได้โดยไม่ต้องแตะ HTML เลยแม้แต่บรรทัดเดียว — เปลี่ยนแค่ CSS variable เท่านั้น
