...
> 💡 ตัวอย่างจากของจริง
>
> Static site generator และ framework อย่าง Astro และ Next.js generate boilerplate นี้ไว้ใน layout ของทุกหน้าให้อัตโนมัติ ทำให้ developer ลืมใส่โดยไม่ได้ตั้งใจแทบไม่เกิดขึ้น ([เอกสาร Astro: Project structure](https://docs.astro.build/en/basics/project-structure/))
