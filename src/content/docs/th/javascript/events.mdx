...
เมื่อคุณเขียน `addEventListener('click', function() { ... })` ฟังก์ชันจะ **ไม่รันทันที** แต่ถูกลงทะเบียนไว้รอ browser จะเรียกก็ต่อเมื่อผู้ใช้คลิกจริงๆ เท่านั้น นี่คือความหมายของคำว่า "callback" — browser โทรกลับมาหาคุณในเวลาที่เหมาะสม
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> Command palette ที่เปิดด้วย Cmd+K ทำงานได้เพราะมีโค้ดที่ "ฟัง" keyboard event นั้นโดยเฉพาะ — เป็นรายละเอียดที่ designer ต้องระบุไว้ล่วงหน้า ไม่ใช่ปล่อยให้เข้าใจเอาเอง

export const quizEvents = [
  {
    q: '"event" ใน browser คืออะไร?',
