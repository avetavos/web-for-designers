...
> 💡 ตัวอย่างจากของจริง
>
> ปุ่ม submit ที่เปลี่ยนเป็น spinner แล้วเป็นเครื่องหมายถูก ช่วยให้ user มั่นใจว่า action สำเร็จจริง โดยไม่ต้อง reload หน้าเลย
...
export const quizInteractions = [
  ...
  },
  {
    ...
    options: ['CSS ช้ากว่า JS', 'CSS จัดการ visual logic และเปลี่ยนได้โดยไม่แตะ JavaScript', 'JS อ่าน CSS ไม่ได้', 'browser ไม่สนใจ inline styles'],
    answer: 1,
  },
  {
