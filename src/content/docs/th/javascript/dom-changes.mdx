...
JavaScript แค่เพิ่มหรือลบชื่อ class เท่านั้น — ไม่เคยตั้งค่าสีหรือ spacing โดยตรง ความแตกต่างทางภาพทั้งหมดอยู่ใน CSS ของคุณ (`.card` กับ `.card.highlighted`) การแยกส่วนนี้ทำให้ style อยู่ในที่เดียวและ logic อยู่อีกที่หนึ่ง เหมือนกับความสัมพันธ์ระหว่าง component กับ variant ของตัวเองในเครื่องมือออกแบบ
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> การติ๊กเสร็จ to-do item ใน web app สมัยใหม่มักไม่ reload หน้าเลย — JavaScript แก้ DOM แค่แถวนั้นแถวเดียว (ขีดทับ + เปลี่ยนสี) ทันที
