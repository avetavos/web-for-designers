...
> 💡 ตัวอย่างจากของจริง
>
> การเลือก layer ที่มีคุณสมบัติเดียวกันทั้งหมดในเครื่องมือออกแบบ กับ `document.querySelectorAll()` ใน JavaScript แก้ปัญหาเดียวกัน — หา element ทั้งหมดที่ตรงเงื่อนไขเดียวมาจัดการพร้อมกัน
