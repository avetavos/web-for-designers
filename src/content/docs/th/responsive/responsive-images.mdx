...
> 💡 ตัวอย่างจากของจริง
>
> Image CDN ที่ปรับขนาดรูปต้นฉบับเดียวกันให้เหมาะกับแต่ละอุปกรณ์อัตโนมัติ ทำให้มือถือโหลดไฟล์เล็กกว่า desktop หลายเท่า ทั้งที่รูปยังดูเหมือนกันทุกประการ
