...
> 💡 ตัวอย่างจากของจริง
>
> GOV.UK Frontend ออกแบบ CSS ให้ใช้หน่วย relative อย่าง rem โดยเฉพาะ เพราะช่วยให้ตัวอักษร resize ถูกต้องเมื่อ user zoom หรือปรับขนาด font ของ browser ให้ใหญ่ขึ้น ([GOV.UK Design System: Type scale](https://design-system.service.gov.uk/styles/type-scale/))
