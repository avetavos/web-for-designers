...
ถ้าคุณพบว่าตัวเองเขียน CSS เดิมสำหรับปุ่มที่สอง หยุด ดึงออกมาเป็น class `.btn` ถ้าคุณเขียนการ์ดที่สาม ให้แน่ใจว่าใช้ class `.card` เดียวกับสองอันแรก การ reuse ใน CSS ไม่ใช่ความขี้เกียจ — แต่เป็นวินัยที่รักษา design system ให้สอดคล้องกัน
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> Design system ของ Atlassian ระบุ state จริงของปุ่มไว้ครบ — default, disabled, selected, loading — ตรงกับ state ที่ code component ของจริง implement ไว้ ([Atlassian Design System: Button](https://atlassian.design/components/button/examples))
