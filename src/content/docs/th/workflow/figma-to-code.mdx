...
> 💡 ตัวอย่างจากของจริง
>
> การตั้งชื่อ layer หรือ component ใน Figma ให้ตรงกับชื่อ code component จริงที่จะกลายเป็น (เช่น "Button/Primary") ทำให้ขั้นตอน handoff กลายเป็นการ "เปิดดูชื่อ" แทนการเดา
