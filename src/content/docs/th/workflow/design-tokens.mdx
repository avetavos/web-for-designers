...
<Tip title="ถ้าใช้สีมากกว่าหนึ่งครั้ง ให้ทำเป็น token">
...
> 💡 ตัวอย่างจากของจริง
>
> รูปแบบของ W3C Design Tokens Community Group พยายามทำให้เครื่องมืออย่าง Figma กับโค้ดใช้ไฟล์ token ต้นทางเดียวกัน เพื่อให้ค่าสีหรือ spacing มีแหล่งความจริงเดียว ไม่ใช่สองแหล่งที่ค่อย ๆ เพี้ยนออกจากกัน
