...
ย่อหน้า element ที่ซ้อนกันด้วยช่องว่างสองช่อง (หรือ tab) ไม่มีผลต่อวิธีที่ browser อ่านไฟล์ แต่ทำให้มองเห็นโครงสร้างได้ทันที — เหมือนการตั้งชื่อและจัดกลุ่ม layer ใน Figma ให้เป็นระเบียบ โค้ดที่อ่านยากคือโค้ดที่แก้ยาก
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> `<button>` จริงใช้งานผ่านคีย์บอร์ดได้ทันที (Enter/Space, รับ tab focus) ตั้งแต่วางลงในหน้า ส่วน `<div>` ที่แต่งให้ดูเหมือนปุ่มต้องเขียน JavaScript และ ARIA เพิ่มเพื่อให้ได้พฤติกรรมพื้นฐานแบบเดียวกัน
