...
> 💡 ตัวอย่างจากของจริง
>
> Reader mode ของ browser (เช่น Safari Reader หรือ Firefox Reader View) อาศัย landmark อย่าง `<main>` และ `<article>` เพื่อแยกว่าส่วนไหนของหน้าคือเนื้อหาจริงที่ควรดึงออกมาแสดง
...
export const quizSemantic = [
  ...
  },
  {
    ...
    options: [
      'เพิ่ม bullet point ให้ลิงก์โดยอัตโนมัติ',
      'บอก browser screen reader และ search engine ว่านี่คือ region ของ navigation',
      'ทำให้ลิงก์เปิดในแท็บใหม่',
      'ทำให้ไม่จำเป็นต้องใช้ CSS',
    ],
    answer: 1,
  },
  {
