...
> 💡 ตัวอย่างจากของจริง
>
> การ serve รูปเดียวกันหลาย resolution ผ่าน `srcset` ทำให้ browser เลือกไฟล์เล็กที่สุดที่ยังคมชัดบนหน้าจอนั้นได้เอง มือถือจึงโหลดข้อมูลน้อยกว่า desktop มากสำหรับรูปเดียวกัน
...
export const quizImages = [
  ...
  },
  {
    ...
    options: [
      'browser แสดงเฉพาะไอคอนรูปภาพที่เสีย',
      'browser ซ่อนพื้นที่นั้นไปทั้งหมด',
      'browser แสดง alt text แทนที่รูปภาพ',
