...
> 💡 ตัวอย่างจากของจริง
>
> Auto Layout ใน Figma แปลงเป็น Flexbox ได้ตรงที่สุดเมื่อเทียบกับวิธีจัด layout อื่นใน CSS จึงเป็นเหตุผลที่ developer มักเลือก Flexbox เป็นตัวแรกเมื่อ design ใช้ Auto Layout
