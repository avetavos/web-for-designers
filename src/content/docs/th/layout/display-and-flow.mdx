...
description: 'browser เรียง elements ตามค่าเริ่มต้นอย่างไร และ display: block, inline, inline-block หมายความว่าอะไร'
---
...
`inline-block` มีประโยชน์มากสำหรับ navigation links, tags และ badge components element เหล่านี้ไหลเป็นธรรมชาติในข้อความเหมือน inline elements แต่คุณสามารถให้ padding, width และ height ที่แน่นอนได้เหมือน block elements คุณจะได้ใช้ตลอดสำหรับ UI chips และ labels
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> Editor แบบ block ที่ปล่อยให้เนื้อหายืด/หดตามจำนวนตัวอักษรได้เอง อาศัย normal flow (block-level element เรียงต่อกัน) เป็นพื้นฐานเท่านั้น ไม่ต้องใช้ absolute positioning เลย
...
export const quizDisplayFlow = [
  ...
  },
  {
    ...
    options: [
      ...
      'ย้าย element ออกไปนอกหน้าจอทางซ้าย',
