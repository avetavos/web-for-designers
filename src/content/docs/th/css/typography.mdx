...
> 💡 ตัวอย่างจากของจริง
>
> การเลือก fallback font ที่มีขนาดและระยะห่างใกล้เคียงกับ font จริง (แบบ "metric-compatible") ช่วยไม่ให้หน้าเว็บกระตุกเห็นได้ชัดตอน font จริงโหลดเสร็จ
