...
Class คือ selector ที่คุณจะใช้บ่อยที่สุด ลองนึกถึง class เหมือน component variant ใน Figma — กำหนดสไตล์ครั้งเดียว ใช้ได้กับ element เท่าไหร่ก็ได้ ส่วน ID นั้นดี แต่ควรเก็บไว้สำหรับสิ่งที่ปรากฏแค่ครั้งเดียวในหน้าจริงๆ
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> Design system แบบ component ส่วนใหญ่ตั้งชื่อ class ตาม role ของ component (`.button--primary`, `.button--danger`) ไม่ใช่ตามสี ทำให้เปลี่ยนสีของ theme ได้โดยไม่ต้องเปลี่ยนชื่อ class เลย
