...
> 💡 ตัวอย่างจากของจริง
>
> เว็บผลิตภัณฑ์หลายแห่งใช้ CSS gradient แทนไฟล์รูปสำหรับพื้นหลัง เพราะทำให้เพจเบาและขยายได้แบบไม่แตกที่ทุกขนาดหน้าจอ ต่างจากไฟล์รูปที่ต้องแลกกับขนาดไฟล์ที่หนักขึ้น
