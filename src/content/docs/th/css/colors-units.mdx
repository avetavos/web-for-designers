...
> 💡 ตัวอย่างจากของจริง
>
> Framework อย่าง Tailwind CSS มาพร้อม spacing และ color scale ที่กำหนดไว้ตายตัว — แนวคิดเดียวกับชุด design token ใน Figma เพียงแต่แสดงผลเป็น CSS/utility class แทน design variable
