...
ช่องว่าง**ภายนอก**กล่อง ผลัก element เพื่อนบ้านออกไป ส่วนนี้ไม่ใช่พื้นที่แสดงผลของ element — แต่เป็นช่องว่างล่องหนระหว่างกล่อง นึกถึง gap ระหว่าง frame ใน Figma
...
เพิ่ม `box-sizing: border-box` ใน global styles ของทุก project เสมอ ทำให้การกำหนดขนาด element คาดเดาได้และตรงกับพฤติกรรม default ของ design tool ส่วนใหญ่ รวมถึง Figma ถ้าไม่มีบรรทัดนี้ การเพิ่ม padding ให้ element ที่กำหนดขนาดไว้จะทำให้ layout พังในแบบที่ debug ยาก
</Tip>
...
> 💡 ตัวอย่างจากของจริง
>
> แผง Inspect ใน Dev Mode ของ Figma แสดงค่า padding/spacing ที่ map ตรงกับ CSS box model ทำให้ developer อ่านค่าไปใช้ในโค้ดได้ทันที ([Figma: Guide to Dev Mode](https://help.figma.com/hc/en-us/articles/15023124644247-Guide-to-Dev-Mode))
